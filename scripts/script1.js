...
var patent="<table><tr><td><strong>Project Aim: </strong></td><td>Home automation system using a simple Android app, which you can use to control electrical appliances with clicks or voice commands. Commands are sent via Bluetooth to Arduino Uno. So you need not get up to switch on or switch off the device while watching a movie or doing some work.</td></tr></table>"
$(document).ready(
    function() {
        $('#p1').html(prog);
    }
